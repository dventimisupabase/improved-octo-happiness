...
case "$RUNG" in
  R0) export BENCH_ROWS=1000000   BENCH_MONTHS=6  BENCH_CHUNK=1000000 BENCH_CHUNK_INTERVAL='1 week' BENCH_PHASE_SECS=30 BENCH_DRAIN_BATCH=50000  BENCH_DRAIN_MAX_SECS=1200 ;;
  R1) export BENCH_ROWS=3000000   BENCH_MONTHS=6  BENCH_CHUNK=1500000 BENCH_CHUNK_INTERVAL='1 week' BENCH_PHASE_SECS=30 BENCH_DRAIN_BATCH=50000  BENCH_DRAIN_MAX_SECS=1200 ;;
  R2) export BENCH_ROWS=10000000  BENCH_MONTHS=6  BENCH_CHUNK=2000000 BENCH_CHUNK_INTERVAL='3 days' BENCH_PHASE_SECS=45 BENCH_DRAIN_BATCH=100000 BENCH_DRAIN_MAX_SECS=1800 ;;
  R3) export BENCH_ROWS=40000000  BENCH_MONTHS=6  BENCH_CHUNK=2000000 BENCH_CHUNK_INTERVAL='1 day'  BENCH_PHASE_SECS=60 BENCH_DRAIN_BATCH=150000 BENCH_DRAIN_MAX_SECS=3600 ;;
  R4) export BENCH_ROWS=120000000 BENCH_MONTHS=12 BENCH_CHUNK=2000000 BENCH_CHUNK_INTERVAL='1 day'  BENCH_PHASE_SECS=90 BENCH_DRAIN_BATCH=250000 BENCH_DRAIN_MAX_SECS=36000 ;;
  R5) export BENCH_ROWS=350000000 BENCH_MONTHS=12 BENCH_CHUNK=2000000 BENCH_CHUNK_INTERVAL='12 hours' BENCH_PHASE_SECS=90 BENCH_DRAIN_BATCH=500000 BENCH_DRAIN_MAX_SECS=90000 ;;
