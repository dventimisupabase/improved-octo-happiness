...
select pgpm.adopt_by_id('public.m', 'id', 100, p_premake => 2, p_drain_batch => 500,
...
select is(
  (select count(*)::int from pgpm.dropped_fk where parent_table = 'public.m'::regclass and restorable),
  1, 'the FK was recorded as restorable');
